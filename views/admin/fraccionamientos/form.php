                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="<?= htmlspecialchars($fraccionamiento['representante_nombre'] ?? $_POST['representante_nombre'] ?? '') ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="email" 
                                           ...
                                           value="<?= htmlspecialchars($fraccionamiento['representante_email'] ?? $_POST['representante_email'] ?? '') ?>">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="tel" 
                                           ...
                                           value="<?= htmlspecialchars($fraccionamiento['representante_telefono'] ?? $_POST['representante_telefono'] ?? '') ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
